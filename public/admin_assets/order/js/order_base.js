...
function setDateTable(table, officeType) {
    ...
    if (officeType === 'Арбатская') {
        ...
        var butSu = dayWeek[6].su.statusArbat === true ? "<button data-type='close' data-office-type='" + officeType + "' data-date='" + dayWeek[6].su.date + "' type='button' class='but-update-status-day btn btn-info'>Закрыт</button>" : "<button data-type='open' data-office-type='" + officeType + "' data-date='" + dayWeek[6].su.date + "' type='button' class='but-update-status-day btn btn-success'>Открыт</button>";
